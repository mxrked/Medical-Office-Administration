...
"}")
        ...
        self.InputsInnerFrame.setGeometry(QtCore.QRect(110, 190, 591, 351))
...
"}")
        ...
        self.TimesHolderFrame_SA.setGeometry(QtCore.QRect(730, 200, 341, 331))
...
"}")
        ...
        self.ScheduleAppointmentBtn.setGeometry(QtCore.QRect(730, 560, 341, 51))
        font = QtGui.QFont()
        font.setFamily("Lato")
        font.setPointSize(11)
        font.setBold(True)
...
"")
        ...
        self.ClearInputsBtn.setGeometry(QtCore.QRect(370, 560, 141, 51))
        font = QtGui.QFont()
        font.setFamily("Lato")
        font.setPointSize(11)
        font.setBold(True)
...
"}")
        ...
        self.DisplayAvailableTimes_Btn_SA.setGeometry(QtCore.QRect(120, 560, 241, 51))
        font = QtGui.QFont()
        font.setFamily("Lato")
        font.setPointSize(11)
        font.setBold(True)
...
"}")
        ...
        self.Frame_SelectDoctor_CA.setGeometry(QtCore.QRect(90, 270, 441, 61))
...
"}")
        ...
        self.Frame_SelectDoctor_CA_2.setGeometry(QtCore.QRect(90, 210, 441, 61))
...
"")
        ...
        self.CancelAppointment_Label.setGeometry(QtCore.QRect(100, 470, 481, 51))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(12)
...
"    color: white;\n"
"}")
        self.CancelAppointment_Label.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.Frame_SelectDoctor_CA_3.setGeometry(QtCore.QRect(90, 330, 441, 61))
...
"}")
        ...
        self.SearchForAppointments_Btn_CA.setGeometry(QtCore.QRect(100, 400, 221, 51))
        font = QtGui.QFont()
        font.setFamily("Lato")
        font.setPointSize(11)
        font.setBold(True)
...
"}")
        ...
        self.Frame_SelectDoctor_RA.setGeometry(QtCore.QRect(160, 240, 471, 61))
...
"}")
        ...
        self.Frame_SelectOfficeLocation_RA.setGeometry(QtCore.QRect(160, 180, 471, 61))
...
"}")
        ...
        self.UnderHeadingTextLabel_RA_1.setGeometry(QtCore.QRect(160, 450, 431, 51))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(12)
...
"}")
        ...
        self.UnderHeadingTextLabel_RA_3.setGeometry(QtCore.QRect(170, 490, 421, 51))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(12)
...
"}")
        ...
        self.SearchedAppointments_Label_RA.setGeometry(QtCore.QRect(0, -20, 331, 51))
        font = QtGui.QFont()
        font.setFamily("Lato")
        font.setPointSize(14)
...
"}")
        ...
        self.CurrentAvailableTimes_Label_RA.setGeometry(QtCore.QRect(0, -20, 331, 51))
        font = QtGui.QFont()
        font.setFamily("Lato")
        font.setPointSize(14)
...
"}")
        ...
        self.Frame_SelectDoctor_RA_2.setGeometry(QtCore.QRect(160, 300, 471, 61))
...
"}")
        ...
        self.SearchForAppointments_Btn_RA.setGeometry(QtCore.QRect(170, 380, 221, 51))
        font = QtGui.QFont()
        font.setFamily("Lato")
        font.setPointSize(11)
        font.setBold(True)
...
"")
        ...
        self.DisplayCurrentTimes_Btn_RA.setGeometry(QtCore.QRect(400, 380, 221, 51))
        font = QtGui.QFont()
        font.setFamily("Lato")
        font.setPointSize(11)
        font.setBold(True)
