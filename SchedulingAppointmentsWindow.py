...
"}")
        ...
        self.ListWidget_MeetDateTimes.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.ListWidget_MeetDateTimes.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.ListWidget_MeetDateTimes.addItem(item)
...
"")
        ...
        self.ScheduleAppointmentBtn.setEnabled(False)
...
"}")
    ...
    def retranslateUi(self, SchedulingAppointmentsWindow):
        ...
        __sortingEnabled = self.ListWidget_MeetDateTimes.isSortingEnabled()
        self.ListWidget_MeetDateTimes.setSortingEnabled(False)
        item = self.ListWidget_MeetDateTimes.item(0)
        item.setText(_translate("SchedulingAppointmentsWindow", "Test Date/Time 1"))
        item = self.ListWidget_MeetDateTimes.item(1)
        item.setText(_translate("SchedulingAppointmentsWindow", "Test Date/Time 2"))
        item = self.ListWidget_MeetDateTimes.item(2)
        item.setText(_translate("SchedulingAppointmentsWindow", "Test Date/Time 3"))
        self.ListWidget_MeetDateTimes.setSortingEnabled(__sortingEnabled)
